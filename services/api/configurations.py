...
start_date = os.getenv("TICK_START", "2024-06-21T11:00+02:00")
...
vm_ip = os.getenv("VM_IP", "10.60.15.1")

services = [{"ip": vm_ip, "port": 80, "name": "CTFe"},
            {"ip": vm_ip, "port": 5005, "name": "CTFe1-Cat Roulette"},
            {"ip": vm_ip, "port": 5006, "name": "CTFe2-NotEBook"},
            {"ip": vm_ip, "port": 5000, "name": "WeirdCPU"},
            {"ip": vm_ip, "port": 5555, "name": "SaaS"},
            {"ip": vm_ip, "port": 1234, "name": "NotEBook"}]
